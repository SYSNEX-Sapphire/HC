        ...
        internal class RecipeStateUpader: IDisposable
        {
            ...
            private void updateControlValue(string flowControllerID, float value)
            {
                ...
                switch (flowControllerID)
                {
                    ...
                    case "Temperature1":
                        currentSelected.F01 = value;
                        break;

                    case "Temperature2":
                        currentSelected.F02 = value;
                        break;

                    case "Temperature3":
                        currentSelected.F03 = value;
                        break;

                    case "Temperature4":
                        currentSelected.F04 = value;
                        break;

                    case "Temperature5":
                        currentSelected.F05 = value;
                        break;

                    case "Temperature6":
                        currentSelected.F06 = value;
                        break;
            ...
            private float getControlValue(string flowControllerID)
            {
                ...
                switch (flowControllerID)
                {
                    ...
                    case "Temperature1":
                        return currentSelected.F01;

                    case "Temperature2":
                        return currentSelected.F02;

                    case "Temperature3":
                        return currentSelected.F03;

                    case "Temperature4":
                        return currentSelected.F04;

                    case "Temperature5":
                        return currentSelected.F05;

                    case "Temperature6":
                        return currentSelected.F06;
