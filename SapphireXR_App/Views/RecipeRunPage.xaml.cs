...
namespace SapphireXR_App.Views
{
    public class RecipeLoopReadOnlyBindingProxy : Freezable
    {
        ...
        public static readonly DependencyProperty DataContextProperty = DependencyProperty.Register("DataContext", typeof(object), typeof(RecipeLoopReadOnlyBindingProxy));
    }
