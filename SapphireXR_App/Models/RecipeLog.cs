...
#pragma warning restore CS8618 // null을 허용하지 않는 필드는 생성자를 종료할 때 null이 아닌 값을 포함해야 합니다. 'required' 한정자를 추가하거나 nullable로 선언하는 것이 좋습니다.
        ...
        public float PV_TEMP1 { get; set; }
        public float PV_TEMP2 { get; set; }
        public float PV_TEMP3 { get; set; }
        public float PV_TEMP4 { get; set; }
        public float PV_TEMP5 { get; set; }
        public float PV_TEMP6 { get; set; }
        ...
        public float SV_TEMP1 { get; set; }
        public float SV_TEMP2 { get; set; }
        public float SV_TEMP3 { get; set; }
        public float SV_TEMP4 { get; set; }
        public float SV_TEMP5 { get; set; }
        public float SV_TEMP6 { get; set; }
